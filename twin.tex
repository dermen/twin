...
Note that these are supplementary angles, which is a direct consequence of Friedel symmetry [refs] between $G_{11\bar{1}}$ and $G_{\bar{1}\bar{1}1}$. Table 1 lists the expected CXS correlations from homogenous FCC NPs.
